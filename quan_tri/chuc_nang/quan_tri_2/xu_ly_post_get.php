...
<?php
	...
	if(isset($_POST['bieu_mau_them_thanh_vien']))
	{
		include("chuc_nang/quan_tri_2/them_thanh_vien_vao_csdl.php");
		header("Location:index.php?thamso=quan_ly_thanh_vien");
	}	

	if(isset($_POST['bieu_mau_sua_thanh_vien']))
	{
		include("chuc_nang/quan_tri_2/sua_thanh_vien_vao_csdl.php");
		header("Location:index.php?thamso=quan_ly_thanh_vien");
		// trang_truoc_html();
	}
